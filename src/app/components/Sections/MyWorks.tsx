...
const works = [
  {occupation: "Web Developer", enterprise: "Prefeitura de Mesquita.", objective: "Atuo desenvolvendo aplicações para Web utilizando JS, TS, React e Firebase.", time: "2023 - atualmente"},
  {occupation: "Frontend Developer", enterprise: "Nexa.", objective: "Atuava desenvolvendo landing pages (Páginas de venda) utilizando HTML, CSS e JS.", time: "2021 - 2022"},
  {occupation: "Autonômo", enterprise: "", objective: "Criação de sites, landing pages e sistemas para web.", time: "2019 - atualmente"},
]
