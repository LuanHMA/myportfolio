...
const projectsData = [ 
  ...
  },
  {
    ...
    description:  "Um clone da interface da tela inicial de filmes da Netflix, desenvolvido com a API da Tmdb.", 
  ...
  {
    name: "GitHub Search",
    description:  "Obtenha informações de um usuário do Github apenas digitando seu nome de usuário!", 
  ...
  {
    name: "Jogo da velha",
    description:  "O clássico jogo da velha, jogue junto com um amigo(a) e decida quem é o melhor!", 
    techs: ["HMTL", "CSS", "JS"], 
    ...
    <Section id="myProjects">
      <div className="flex flex-col space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {projectsData.map(({description,developedIn,name,projectLink,repoLink,techs})=>{            
            return(
              <div className="sm:max-w-md sm:min-h-[280px] bg-white shadow-md rounded-xl p-6 space-y-4 transition-all hover:shadow-2xl hover:scale-105 dark:bg-[#253238]">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-x-2">
                    <a href={repoLink} target={"_blank"} title="Acessar repositório">
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-xs font-light text-gray-400 dark:text-white">Desenvolvido em: {developedIn}</p>
